...
import criteriaImg from '../assets/images/datalead/datalead.jpeg';
import verifyImg from '../assets/images/datalead/dataenrich-lead.jpeg';
import scoringImg from '../assets/images/datalead/segmentation-lead.jpeg';
import integrationImg from '../assets/images/datalead/baseunifiee-lead.jpeg';
import dataleadVideo from '../assets/video/data-lead.mp4';
      ...
      <div style={{ backgroundColor: '#0A0A1A', color: '#F9FAFB', minHeight: '100vh', paddingBottom: '4rem', fontFamily: '"Open Sans", Arial, sans-serif' }}>
        ...
        <section style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 4, height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingLeft: '8%' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <Link to="/contact" style={{ backgroundColor: '#2563EB', color: '#fff', padding: '1.3rem 2.5rem', borderRadius: '0.5rem', fontWeight: 600, border: 'none', cursor: 'pointer', textDecoration: 'none' }}>RDV avec un expert</Link>
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ 
            ...
            {/* Colonne Droite: CardFlip (nouvelle version) */}
            <div style={{ flex: '1 1 300px', display: 'flex', justifyContent: 'center' }}>
              <CardFlip 
                title="Data Lead"
                subtitle="Génération de pipeline"
                description="Identification et enrichissement des contacts stratégiques correspondant à votre ADN de vente."
                features={[
                  "Sources de données premium",
                  "Nettoyage & Dé-doublonnage",
                  "Enrichissement LinkedIn",
                  "Livrables prêts à l'appel"
                ]}
                color="#2563EB"
              />
            </div>
