...
import bgFormation from '../assets/images/blog/formationcommercialeB2B.jpeg';
      ...
      <section style={{ position: 'relative', minHeight: '80vh', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, paddingTop: '100px', paddingBottom: '60px' }}>
          <div style={{ maxWidth: '850px', marginInline: 'auto', textAlign: 'center' }}>
            <Link to="/ressources" style={{ display: 'inline-flex', alignItems: 'center', color: 'rgba(255,255,255,0.6)', fontSize: '0.95rem', marginBottom: '2.5rem', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = '#F9FAFB'} onMouseLeave={(e) => e.target.style.color = 'rgba(255,255,255,0.6)'}>
            ...
            <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 3.8rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '2.5rem', color: '#FFFFFF', letterSpacing: '-0.02em', textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
              Formation commerciale B2B : comment rendre votre équipe autonome et performante avec l'IA
            </h1>
      ...
      <section className="section-padding container" style={{ paddingTop: '0' }}>
        <div className="fade-in" style={{ maxWidth: '800px', marginInline: 'auto', fontSize: '1.15rem', lineHeight: 1.8, color: '#D1D5DB' }}>
          ...
          <div style={{ background: 'linear-gradient(145deg, #0A0A1A, #0D0D25)', border: '1px solid #2563EB', borderRadius: '12px', padding: '3rem', textAlign: 'center' }}>
            ...
            <Link to="/formation-ia" className="btn btn-primary pulse" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#2563EB', color: '#FFFFFF' }}>
