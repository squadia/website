...
import fondAutoIA from '../assets/images/automatisation/automatisationbg.jpeg';
import auto1 from '../assets/images/automatisation/auto1.webp';
import auto2 from '../assets/images/automatisation/auto2.webp';
import auto3 from '../assets/images/automatisation/auto3.webp';
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem', alignItems: 'stretch' }}>
            ...
            <div style={{ background: '#0D0D25', border: '1px solid #1A1A3A', padding: '3rem 2rem', borderRadius: '1rem', display: 'flex', flexDirection: 'column' }}>
              ...
              <Link to="/contact" style={{ background: 'transparent', border: '1px solid rgba(255,255,255,0.2)', color: '#fff', padding: '1rem', borderRadius: '0.5rem', textAlign: 'center', fontWeight: 700, textDecoration: 'none' }}>
                Choisir Starter
              </Link>
            </div>
            ...
            <div style={{ background: '#0D0D25', border: '2px solid #2563EB', padding: '3rem 2rem', borderRadius: '1rem', display: 'flex', flexDirection: 'column', position: 'relative' }}>
              ...
              <Link to="/contact" style={{ background: '#2563EB', color: '#fff', padding: '1rem', borderRadius: '0.5rem', textAlign: 'center', fontWeight: 700, textDecoration: 'none' }}>
                Choisir Scale
              </Link>
            </div>
      ...
      <section style={{ padding: '10rem 2rem', maxWidth: '850px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <AccordionItem 
            ...
            answer={<>Oui, idéalement. L'automatisation connecte des briques existantes. Si votre CRM n'est pas prêt, nous pouvons vous accompagner sur la phase <Link to="/strategie-crm" style={{ color: '#2563EB', textDecoration: 'underline' }}>Stratégie CRM</Link> au préalable.</>}
          />
          <AccordionItem 
