...
import bgCommercial from '../assets/images/stratcom/ceocommercial.jpeg';
import commercialMeeting from '../assets/images/commerciale-meeting.png';
import comstratVideo from '../assets/video/comstrat.mp4';
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', alignItems: 'center' }}>
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <Link to={activeItem.link} style={{ backgroundColor: '#2563EB', color: '#FFFFFF', fontWeight: 600, padding: '1.1rem 2.8rem', borderRadius: '8px', display: 'inline-flex', alignItems: 'center', fontSize: '1rem', textDecoration: 'none', boxShadow: '0 10px 25px rgba(37,99,235,0.25)', transition: 'transform 0.2s ease' }}>
                    {activeItem.cta}
                  </Link>
                </motion.div>
              </AnimatePresence>
      ...
      <div style={{ backgroundColor: '#0A0A1A', color: '#F9FAFB', minHeight: '100vh', paddingBottom: '4rem', fontFamily: '"Open Sans", Arial, sans-serif' }}>
        ...
        <section id="hero" style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 4, height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingLeft: '8%' }}>
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} style={{ fontSize: 'clamp(2.5rem, 5vw, 3.5rem)', fontWeight: 700, lineHeight: 1.1, color: '#F9FAFB', marginBottom: '1.5rem', maxWidth: '900px' }}>
