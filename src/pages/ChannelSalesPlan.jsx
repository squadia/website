...
import planPartenaire from '../assets/images/ressources/plan-partenaire.jpeg';
...
const ChannelSalesPlan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://hook.eu1.make.com/p6lmievgp9ti64bnl1qjajhkyy2jt1zu', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="channel-sales-page" style={{ position: 'relative', minHeight: '100vh', color: '#F9FAFB', overflow: 'hidden' }}>
