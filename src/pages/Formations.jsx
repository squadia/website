...
import formationBg from '../assets/images/formationB2B.png';
import salesImg from '../assets/images/formation/commercial.png';
import marketingImg from '../assets/images/formation/marketing.jpeg';
import communicationImg from '../assets/images/formation/communication.jpeg';
  ...
  return (
    ...
    >
      ...
      <div className="card-content-wrap">
        ...
        <Link to={link} className="btn-discover-new">
            ...
            <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: '0', background: '#0A0A1A', border: '1px solid rgba(68, 204, 255, 0.15)', borderRadius: '12px', overflow: 'hidden' }}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ padding: '2rem' }}><Link to="/formation-ventes-et-ia" style={{ color: '#44CCFF', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '8px' }}>Voir le programme <ArrowRight size={16} /></Link></td>
                  <td style={{ padding: '2rem' }}><Link to="/formation-marketing-et-ia" style={{ color: '#44CCFF', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '8px' }}>Voir le programme <ArrowRight size={16} /></Link></td>
                  <td style={{ padding: '2rem' }}><Link to="/formation-communication-et-ia" style={{ color: '#44CCFF', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '8px' }}>Voir le programme <ArrowRight size={16} /></Link></td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="section-padding" style={{ background: '#0A0A1A', borderTop: '1px solid rgba(255, 255, 255, 0.05)' }}>
        <div className="container fade-in" style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', justifyContent: 'center', marginTop: '24px' }}>
            <Link to="/strategie-ia" className="pill-link">Structurer votre stratégie IA</Link>
            <Link to="/data" className="pill-link">Détecter vos leads qualifiés</Link>
            <Link to="/automatisation-ia" className="pill-link">Automatiser vos processus</Link>
          </div>
        </div>
      </section>
