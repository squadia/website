...
const FormationCommunicationIA = () => {
  ...
  return (
    <div className="formation-communication-ia" style={{ background: '#F6F3EC', color: '#1C2B27', minHeight: '100vh', fontFamily: 'var(--font-main)' }}>
      ...
      <TestimonialsMarquee page="communication" />
      ...
      <CtaFinalZoom
        ...
        title={<>Prêt à structurer la communication<br />de votre organisation avec l'IA ?</>}
        description="2 jours pour transformer votre production de contenu."
      />
