      ...
      <div className="hero-grid-m" style={{
        ...
        <div className="hero-left-m" style={{
          ...
          <p className="mfu" style={{ fontFamily: fi, fontSize: '1.25rem', lineHeight: 1.65, color: '#bcc8d1', marginBottom: '12px', maxWidth: '46ch', transitionDelay: '.12s' }}>
            Nous avons forgé notre expérience B2B ;<br />Pour le Mid-Market comme pour les Grands Comptes.<br />Du côté des leaders comme celui des challengers.<br />Adressant tous les verticaux (Médias, Banque-Assurance, Santé, etc).
          </p>
