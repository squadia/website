...
const LandingMarketing = () => {
  ...
  const enjeux = [
    ...
    { short: 'Outils déconnectés', title: 'Les outils ne communiquent pas entre eux', desc: "CRM mal configuré, données éparpillées, séquences marketing déconnectées du pipeline commercial. Chaque outil fonctionne dans son coin. La vision globale n'existe pas et la contribution au chiffre reste impossible à prouver.", icon: <Zap color="#8A6D3B" />, image: '/assets/images/marketingdirector/sideration.webp' },
    { short: 'Pression ROI', title: 'La pression sur le ROI marketing augmente', desc: "Les budgets sont questionnés. Les équipes sont jugées sur leur contribution au chiffre d'affaires, pas sur leurs impressions ou leur taux d'ouverture. Prouver la valeur du marketing avec des données fiables devient un enjeu stratégique.", icon: <BarChart3 color="#8A6D3B" />, image: '/assets/images/dg/pbfichier.webp' },
    { short: 'IA sans cadre', title: 'Les initiatives IA bloquent faute de cadre', desc: "Des idées d'automatisation ou de personnalisation attendent depuis des mois. Sans strategie validée au bon niveau, l'IT ou la direction générale freinent. Pas parce que les idées sont mauvaises, mais parce qu'elles n'ont pas de cadre.", icon: <ShieldAlert color="#8A6D3B" />, image: '/assets/images/marketingdirector/plustard.webp' }
  ];

  const apports = [
    { title: "Des leads avec du contexte, pas juste des contacts", desc: "Signaux d'achat, changements de poste, recrutements stratégiques. Les leads Squadia arrivent avec une raison d'acheter maintenant et un angle d'approche. Vos commerciaux savent exactement pourquoi ils appellent.", icon: <Target color="#8A6D3B" /> },
    { title: 'Un pipeline marketing structuré et mesurable', desc: "On aligne les actions marketing sur les objectifs commerciaux réels. Chaque campagne, chaque séquence, chaque lead est connecté à un indicateur de pipeline. La contribution au chiffre devient visible et défendable.", icon: <BarChart3 color="#8A6D3B" /> },
    { title: 'Une automatisation qui libère du temps pour la strategie', desc: "Segmentation, nurturing, reporting, mise à jour CRM. On automatise ce qui prend du temps sans valeur ajoutée. Vos équipes se concentrent sur ce qui compte vraiment.", icon: <Zap color="#8A6D3B" />, link: { href: '/automatisation-ia.html', label: 'Découvrir nos automatisations' } },
    { title: 'Une équipe formée pour exploiter les outils en place', desc: "Pas d'adoption en demi-teinte. On forme votre équipe sur les cas concrets de votre organisation pour que les outils servent vraiment, pas qu'ils restent sous-utilisés après 3 mois.", icon: <CheckCircle2 color="#8A6D3B" /> }
  ];
  ...
  return (
    <div className="landing-marketing" style={{ background: '#F6F3EC', color: '#1C2B27', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '1rem', fontWeight: 500, color: '#1C2B27', marginBottom: '4px', textAlign: 'center' }}>
            Directrice Marketing
          </div>
          <div style={{ fontSize: '0.78rem', color: 'rgba(138,109,59,0.85)', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 5, display: 'flex', flexWrap: 'wrap', width: '100%', paddingTop: '150px', paddingBottom: '7rem', paddingLeft: '8%', paddingRight: '5%' }}>
          <div style={{ flex: '0 0 65%', maxWidth: '850px', paddingRight: '2rem' }}>
            ...
            <h1 style={{
              ...
              marginBottom: '1.5rem', letterSpacing: '-0.02em', color: '#1C2B27',
            ...
            <p style={{
              fontSize: '1.25rem', color: 'rgba(28,43,39,0.6)',
            ...
            <div style={{
              ...
              <div className="dm-kpi-card" style={{ flex: '1 1 190px', padding: '1.2rem', color: '#1C2B27' }}>
                <div style={{ fontSize: '0.8rem', color: 'rgba(28,43,39,0.6)', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>Leads qualifiés</div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.3rem' }}>
                  ...
                  <div style={{ position: 'relative', width: '52px', height: '52px', flexShrink: 0 }}>
                    ...
                    <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.52rem', fontWeight: 700, color: '#8A6D3B' }}>+64%</div>
                  </div>
                </div>
                <div style={{ fontSize: '0.85rem', color: 'rgba(28,43,39,0.6)' }}>
                  <span style={{ color: '#8A6D3B' }}>ce mois</span> : qualification +64%
                </div>
              </div>

              {/* Card 2 : Pipeline marketing */}
              <div className="dm-kpi-card" style={{ flex: '1 1 190px', padding: '1.2rem', color: '#1C2B27' }}>
                <div style={{ fontSize: '0.8rem', color: 'rgba(28,43,39,0.6)', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>Pipeline marketing</div>
                ...
                <div style={{ fontSize: '0.85rem', color: 'rgba(28,43,39,0.6)', marginBottom: '1rem' }}>
                  <span style={{ color: '#8A6D3B' }}>sur objectif</span> : € 350K
                </div>
                {/* Barre de progression 60% */}
                <div style={{ position: 'relative', height: '6px', background: 'rgba(255,255,255,0.8)', borderRadius: '3px', overflow: 'hidden' }}>
                  <div style={{
                    position: 'absolute', top: 0, left: 0, height: '100%',
                    background: '#1F3A33', borderRadius: '3px', width: '0%',
                    animation: 'none',
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '0.4rem' }}>
                  <span style={{ fontSize: '0.7rem', color: 'rgba(28,43,39,0.6)' }}>0</span>
                  <span style={{ fontSize: '0.7rem', color: '#8A6D3B', fontWeight: 600 }}>60%</span>
                </div>
              </div>

              {/* Card 3 : Séquence ICP */}
              <div className="dm-kpi-card" style={{ flex: '1 1 190px', padding: '1.2rem', color: '#1C2B27' }}>
                <div style={{ fontSize: '0.8rem', color: 'rgba(28,43,39,0.6)', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>Séquence ICP active</div>
                <div style={{ fontSize: '1.45rem', fontWeight: 700, lineHeight: 1.2, marginBottom: '0.3rem' }}>ETI Industrie</div>
                <div style={{ fontSize: '0.85rem', color: 'rgba(28,43,39,0.6)', marginBottom: '1rem' }}>
                  <span style={{ color: '#8A6D3B' }}>Taux ouverture</span> : 38%
                </div>
      ...
      <section className="section-padding" style={{ background: '#F6F3EC' }}>
        ...
        <div className="container fade-in">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', fontWeight: 700, color: '#1C2B27', lineHeight: 1.2 }}>Transformer votre marketing en moteur de pipeline</h2>
          </div>
          <div className="dc-bento">
            ...
            <div className="dc-bento-card dc-bento-hero" style={{
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                <h3 style={{ fontSize: '1.3rem', fontWeight: 700, color: '#1C2B27', marginBottom: '0.9rem', lineHeight: 1.2 }}>Le marketing comme moteur de pipeline</h3>
                <p style={{ color: 'rgba(28,43,39,0.65)', fontSize: '1rem', lineHeight: 1.65, maxWidth: '460px', margin: 0 }}>Générer du volume ne suffit plus. Squadia structure vos actions marketing pour qu'elles se traduisent en opportunités commerciales réelles, mesurables et alignées avec les objectifs de vente.</p>
              </div>
            </div>
            ...
            <div className="dc-bento-card dc-bento-stat-top" style={{
              ...
              <div style={{ width: '44px', height: '44px', borderRadius: '12px', background: 'rgba(246,243,236,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <BarChart3 size={20} color="#F6F3EC" />
              </div>
              <div>
                <div style={{ fontSize: '2.4rem', fontWeight: 700, lineHeight: 1 }}>4</div>
                <div style={{ fontSize: '0.9rem', color: 'rgba(246,243,236,0.85)', marginTop: '0.3rem' }}>leviers activés en parallèle</div>
                <div style={{ fontSize: '0.78rem', color: 'rgba(246,243,236,0.72)', marginTop: '0.3rem' }}>Leads · Pipeline · Automatisation · Formation</div>
              </div>
            </div>
            ...
            <div className="dc-bento-card dc-bento-feature" style={{
              ...
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '0.6rem', lineHeight: 1.3, color: '#1C2B27' }}>{apports[3].title}</h3>
              <p style={{ color: 'rgba(28,43,39,0.6)', lineHeight: 1.6, fontSize: '0.88rem', margin: 0 }}>{apports[3].desc}</p>
            </div>
            ...
            <div className="dc-bento-card dc-bento-bottom-1" style={{ background: '#F6F3EC', border: '1px solid #D8D1C2', display: 'flex', flexDirection: 'column' }}>
              ...
              <h3 style={{ fontSize: '1.05rem', fontWeight: 600, marginBottom: '0.6rem', lineHeight: 1.3, color: '#1C2B27' }}>{apports[0].title}</h3>
              <p style={{ color: 'rgba(28,43,39,0.6)', lineHeight: 1.6, fontSize: '0.88rem', margin: 0 }}>{apports[0].desc}</p>
            </div>
            ...
            <div className="dc-bento-card dc-bento-bottom-2" style={{ background: '#F6F3EC', border: '1px solid #D8D1C2', display: 'flex', flexDirection: 'column' }}>
              ...
              <h3 style={{ fontSize: '1.05rem', fontWeight: 600, marginBottom: '0.6rem', lineHeight: 1.3, color: '#1C2B27' }}>{apports[1].title}</h3>
              <p style={{ color: 'rgba(28,43,39,0.6)', lineHeight: 1.6, fontSize: '0.88rem', margin: 0 }}>{apports[1].desc}</p>
            </div>
            ...
            <div className="dc-bento-card dc-bento-bottom-3" style={{ background: '#1F3A33', border: '1px solid #1F3A33', display: 'flex', flexDirection: 'column' }}>
              ...
              <h3 style={{ fontSize: '1.05rem', fontWeight: 600, marginBottom: '0.6rem', lineHeight: 1.3, color: '#F6F3EC' }}>{apports[2].title}</h3>
              <p style={{ color: 'rgba(246,243,236,0.72)', lineHeight: 1.6, fontSize: '0.88rem', margin: 0 }}>{apports[2].desc}</p>
              {apports[2].link && (
                <a href={apports[2].link.href} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', marginTop: '1rem', color: '#8A6D3B', fontWeight: 600, textDecoration: 'none', fontSize: '0.85rem' }}>
      ...
      <section className="section-padding" style={{ background: '#F6F3EC' }}>
        <div className="container fade-in">
          <p style={{ color: '#8A6D3B', fontWeight: 700, textTransform: 'uppercase', marginBottom: '1rem', letterSpacing: '0.1em', fontSize: '0.85rem' }}>+ Efficace ensemble</p>
          ...
          <div className="grid-2" style={{ gap: '4rem', alignItems: 'start', marginBottom: '3rem' }}>
              ...
              <div style={{ marginTop: '2rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  {[
                    ...
                    <div key={i} style={{ background: '#FFFFFF', border: '1px solid rgba(176,141,87,0.35)', borderRadius: '8px', padding: '1rem', fontSize: '0.9rem', fontWeight: 600, color: '#1C2B27' }}>
                      {label}
                    </div>
                  ))}
                </div>
            ...
            <div style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid #D8D1C2', background: '#F6F3EC', position: 'relative', height: '340px' }}>
          ...
          <div>
            <a href="/automatisation-ia.html" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: '#1F3A33', color: '#F6F3EC', padding: '1rem 1.8rem', borderRadius: '8px', fontWeight: 700, textDecoration: 'none', fontSize: '1rem' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          >
            ...
            <div style={{ flex: 2, padding: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              <span style={{ color: '#8A6D3B', fontSize: '13px', fontWeight: 600, marginBottom: '12px', display: 'block', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Marketing Manager</span>
              <h3 style={{ color: '#1C2B27', fontSize: '1.4rem', fontWeight: 700, marginBottom: '12px', lineHeight: 1.25 }}>Mini-guide Marketing Manager B2B : structurer et piloter votre strategie</h3>
              <p style={{ color: 'rgba(28,43,39,0.6)', fontSize: '0.95rem', lineHeight: 1.7, marginBottom: '24px' }}>Stratégie de contenu, pilotage de la demande, outils IA et KPIs marketing pour aligner vos actions sur les objectifs commerciaux.</p>
          ...
          <div className="grid-2" style={{ gap: '2rem', maxWidth: '1200px', marginInline: 'auto' }}>
            <Link href="/blog/prospection-multicanale-b2b-erreurs" style={{ backgroundColor: '#FFFFFF', border: '1px solid #D8D1C2', borderRadius: '1rem', overflow: 'hidden', display: 'flex', flexDirection: 'column', textDecoration: 'none' }}>
              ...
              <div style={{ padding: '2.5rem', textAlign: 'center', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                ...
                <h3 style={{ fontSize: '1.4rem', lineHeight: 1.3, marginBottom: '1.5rem', flexGrow: 1, color: '#1C2B27' }}>Prospection multicanale B2B : 5 erreurs qui font perdre des leads et comment les éviter</h3>
            ...
            <Link href="/blog/nettoyage-segmentation-enrichissement-donnees-b2b" style={{ backgroundColor: '#FFFFFF', border: '1px solid #D8D1C2', borderRadius: '1rem', overflow: 'hidden', display: 'flex', flexDirection: 'column', textDecoration: 'none' }}>
              ...
              <div style={{ padding: '2.5rem', textAlign: 'center', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                ...
                <h3 style={{ fontSize: '1.4rem', lineHeight: 1.3, marginBottom: '1.5rem', flexGrow: 1, color: '#1C2B27' }}>Nettoyage, segmentation et enrichissement des données B2B : comment préparer une campagne qui convertit</h3>
                <div style={{ marginTop: 'auto' }}>
                  <span style={{ backgroundColor: 'rgba(31,58,51,0.1)', color: '#1F3A33', padding: '0.8rem 1.5rem', borderRadius: '0.5rem', fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                    Lire l'article <ChevronDown size={16} style={{ transform: 'rotate(-90deg)' }} />
                  </span>
      ...
      <CtaFinalZoom
        ...
        title={<>Prêt à transformer votre marketing<br />en moteur de pipeline ?</>}
        description="30 minutes pour évaluer votre potentiel de génération de leads."
      />
