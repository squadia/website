    ...
    <div style={{ background: '#0A0A1A', minHeight: '100vh', color: '#F9FAFB' }}>
      <div className="container" style={{ paddingTop: '160px', paddingBottom: '80px', maxWidth: '800px', marginInline: 'auto' }}>
        ...
        <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#44CCFF', marginBottom: '1rem' }}>Article 2 – Conditions de participation</h2>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#44CCFF', marginBottom: '1rem' }}>Article 3 – Duree du jeu</h2>
            <p style={{ fontSize: '1.05rem', color: '#D1D5DB', lineHeight: 1.7 }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#44CCFF', marginBottom: '1rem' }}>Article 4 – Modalites de tirage au sort</h2>
            <p style={{ fontSize: '1.05rem', color: '#D1D5DB', lineHeight: 1.7, marginBottom: '1rem' }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#44CCFF', marginBottom: '1rem' }}>Article 5 – Dotation</h2>
            <p style={{ fontSize: '1.05rem', color: '#D1D5DB', lineHeight: 1.7, marginBottom: '1rem' }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#44CCFF', marginBottom: '1rem' }}>Article 6 – Information des participants</h2>
            <p style={{ fontSize: '1.05rem', color: '#D1D5DB', lineHeight: 1.7, marginBottom: '1rem' }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#44CCFF', marginBottom: '1rem' }}>Article 7 – Responsabilites</h2>
            <p style={{ fontSize: '1.05rem', color: '#D1D5DB', lineHeight: 1.7 }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#44CCFF', marginBottom: '1rem' }}>Article 8 – données personnelles</h2>
            <p style={{ fontSize: '1.05rem', color: '#D1D5DB', lineHeight: 1.7 }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#44CCFF', marginBottom: '1rem' }}>Article 9 – Acceptation du réglement</h2>
            <p style={{ fontSize: '1.05rem', color: '#D1D5DB', lineHeight: 1.7 }}>
