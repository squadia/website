...
const ConditionsParticipation = () => {
  ...
  return (
    <div style={{ background: '#F6F3EC', minHeight: '100vh', color: '#1C2B27' }}>
      <div className="container" style={{ paddingTop: '160px', paddingBottom: '80px', maxWidth: '800px', marginInline: 'auto' }}>
        ...
        <div className="fade-in" style={{ marginBottom: '3rem' }}>
          ...
          >
            <ArrowLeft size={16} /> Retour a l'enquête
          </Link>
        </div>

        <h1 className="fade-in" style={{ fontSize: 'clamp(2rem, 3.2vw, 2.8rem)', lineHeight: '1.2', marginBottom: '4rem', color: '#1C2B27' }}>
          réglement du jeu concours Squadia
        </h1>

        <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
          
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 1 – Organisateur</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7 }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 2 – Conditions de participation</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7, marginBottom: '1rem' }}>
            ...
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7, marginBottom: '1rem' }}>
              La participation est exclusivement réservée aux managers encadrant directement une equipe, avec une responsabilite hierarchique portant sur au moins deux collaborateurs.
            </p>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7, marginBottom: '1rem' }}>
              Ne peuvent pas participer les personnes exercant leur activite professionnelle dans une entreprise dont l activite principale consiste en la revente de données B2B, la prospection commerciale externalisee, la formation a la vente ou au marketing digital, la vente de services de marketing digital ou de communication ayant pour objet la generation de leads ou la prospection pour le compte de tiers.
            </p>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7, marginBottom: '1rem' }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 3 – Duree du jeu</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7 }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 4 – Modalites de tirage au sort</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7, marginBottom: '1rem' }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 5 – Dotation</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7, marginBottom: '1rem' }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 6 – Information des participants</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7, marginBottom: '1rem' }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 7 – Responsabilites</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7 }}>
          ...
          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 8 – données personnelles</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7 }}>
              Les données collectees dans le cadre du jeu sont traitees conformément a la réglementation en vigueur relative a la protection des données personnelles. Elles sont utilisees exclusivement par Squadia a des fins d'analyse, de communication et de prospection professionnelle, et ne sont en aucun cas cédées a des tiers. conformément a la réglementation applicable, chaque participant dispose d'un droit d'accès, de rectification et de suppression des données le concernant.
            </p>
          </section>

          <section>
            <h2 style={{ fontSize: 'clamp(1.6rem, 2.6vw, 2.2rem)', color: '#8A6D3B', marginBottom: '1rem' }}>Article 9 – Acceptation du réglement</h2>
            <p style={{ fontSize: '1.05rem', color: '#4A534F', lineHeight: 1.7 }}>
              La participation au jeu implique l acceptation pleine et entiere du present réglement.
            </p>
          </section>
          
          <div style={{ marginTop: '2rem', borderTop: '1px solid #D8D1C2', paddingTop: '2rem' }}>
            <p style={{ fontSize: '0.9rem', color: '#6B716C', fontStyle: 'italic' }}>
              réglement mis a jour le 8 janvier 2026.
            </p>
          </div>
