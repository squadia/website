    ...
    <div style={{ background: '#F6F3EC', color: '#1C2B27', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '0.6rem', flexWrap: 'wrap', marginBottom: '1.8rem' }}>
            {[
              { label: 'Prospection', color: '#8A6D3B', bg: 'rgba(176,141,87,0.1)' },
              { label: 'Data',        color: '#8A6D3B', bg: 'rgba(176,141,87,0.1)' },
            ].map(t => (
          ...
          <div style={{
            ...
            <span style={{ fontSize: '2.6rem', fontWeight: 700, color: '#8A6D3B', letterSpacing: '-0.03em' }}>+32</span>
            <div>
              <div style={{ fontSize: '0.95rem', fontWeight: 600, color: '#1C2B27' }}>rendez-vous qualifies</div>
              <div style={{ fontSize: '0.8rem', color: 'rgba(28,43,39,0.6)' }}>avec des directeurs d'exploitation en 5 mois</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#F6F3EC', padding: '5rem 0' }}>
        <div className="container">
          <p style={{ fontSize: '0.78rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(28,43,39,0.6)', marginBottom: '2rem' }}>Chiffres cles</p>
