  ...
  return (
    <div className="landing-dg" style={{ background: '#0A0A1A', color: '#F9FAFB', minHeight: '100vh', fontFamily: '"Open Sans", Arial, sans-serif' }}>
      ...
      <CtaFinalZoom
        ...
        title={<>Découvrez comment nous pouvons aider<br />à dynamiser votre organisation</>}
        description="30 minutes pour comprendre votre contexte et diagnostiquer une approche."
      />
