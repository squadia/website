  ...
  return (
    <div style={{ background: '#F6F3EC', color: '#1C2B27', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '0.6rem', flexWrap: 'wrap', marginBottom: '1.8rem' }}>
            {[
              { label: 'Stratégie',      color: '#8A6D3B', bg: 'rgba(176,141,87,0.1)' },
              { label: 'Automatisation', color: '#8A6D3B', bg: 'rgba(176,141,87,0.1)' },
              { label: 'Formation',      color: '#3F7A5E', bg: 'rgba(63,122,94,0.1)' },
            ].map(t => (
          ...
          <div style={{
            ...
            background: 'rgba(176,141,87,0.06)', border: '1px solid rgba(176,141,87,0.2)',
            borderRadius: '12px', padding: '1rem 1.8rem'
          }}>
            <span style={{ fontSize: '2.6rem', fontWeight: 700, color: '#8A6D3B', letterSpacing: '-0.03em' }}>3 sem.</span>
            <div>
              <div style={{ fontSize: '0.95rem', fontWeight: 600, color: '#1C2B27' }}>de zéro à CRM opérationnel</div>
              <div style={{ fontSize: '0.8rem', color: 'rgba(28,43,39,0.6)' }}>2 500 comptes nettoyés, équipes formées, adopté immédiatement</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#F6F3EC', padding: '5rem 0' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(190px, 1fr))', gap: '1rem', marginBottom: '1rem' }}>
            {stats.map((s, i) => (
              <div key={i} style={{
                background: 'rgba(246,243,236,0.6)', border: '1px solid rgba(176,141,87,0.12)',
                ...
                <div style={{ fontSize: '2.2rem', fontWeight: 700, color: '#8A6D3B', lineHeight: 1.1, marginBottom: '0.4rem' }}>{s.value}</div>
      ...
      <section style={{ padding: '5rem 0', borderTop: '1px solid rgba(28,43,39,0.14)' }}>
        <div className="container">
          <div style={{
            background: 'linear-gradient(135deg, rgba(176,141,87,0.05) 0%, rgba(246,243,236,0.0) 60%)',
            border: '1px solid rgba(176,141,87,0.15)',
            borderLeft: '4px solid #B08D57',
            borderRadius: '16px', padding: '3rem'
          }}>
            <p style={{ fontSize: '0.78rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(138,109,59,0.8)', marginBottom: '1.2rem' }}>Ce qui a changé</p>
            <p style={{ fontSize: '1.2rem', lineHeight: 1.75, color: 'rgba(28,43,39,0.75)', maxWidth: '820px' }}>
              En quelques jours après le déploiement, l'équipe travaillait déjà sur un CRM propre, avec une visibilité réelle sur son activité. Les commerciaux ont trouvé dans l'outil <strong style={{ color: '#1C2B27' }}>ce qu'ils cherchaient jusque-là dans des tableaux Excel épars</strong>. Aujourd'hui, la mission se poursuit avec des agents IA qui permettent à chaque commercial de se démultiplier sur un marché qui n'attend pas.
            </p>
          </div>
        </div>
      </section>
