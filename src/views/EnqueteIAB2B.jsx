...
const enquêteIAB2B = () => {
  ...
  useEffect(() => {
    document.title = "enquête IA B2B 2026 : Vos priorités face a l'IA : Squadia";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.content = "Participez à l'enquête Squadia sur les priorités des Sales et Marketing Managers face a l'IA en 2026. Tentez de gagner un bon Relais & Chateaux d'une valeur de 350 EUR.";
    }
  }, []);

  return (
    <div className="enquête-page" style={{ background: '#0A0A1A', minHeight: '100vh', color: '#F9FAFB', display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="container" style={{ paddingTop: '160px', paddingBottom: '80px', maxWidth: '900px', marginInline: 'auto' }}>
          ...
          <div className="fade-in" style={{ textAlign: 'center', marginBottom: '4rem' }}>
            ...
            <p style={{ fontSize: '1.25rem', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
              Dans cette étude, decouvrez comment vos pairs se préparent a adapter l'IA et la data en 2026... et tentez de gagner un bon Relais & Chateaux d'une valeur de 350 EUR TTC. Date du tirage au sort redéfinie au 31 mars 2026, sous reserve des conditions de participation.
            </p>
          </div>
          ...
          <div className="fade-in" style={{ background: '#0D0D25', border: '1px solid #1A1A3A', borderRadius: '12px', padding: '3rem 2.5rem', marginBottom: '4rem' }}>
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                <CheckCircle2 size={24} color="#44CCFF" style={{ flexShrink: 0, marginTop: '2px' }} />
                <span style={{ fontSize: '1.1rem', color: '#E5E7EB', lineHeight: 1.5 }}>
                  Le role réel de l'IA dans la prospection et le marketing B2B
                </span>
              </li>
              <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                <CheckCircle2 size={24} color="#44CCFF" style={{ flexShrink: 0, marginTop: '2px' }} />
          ...
          <div className="fade-in" style={{ textAlign: 'center', marginBottom: '5rem' }}>
            ...
            >
              Je participe a l'étude SQUADIA <ExternalLink size={20} />
            </a>
          </div>
