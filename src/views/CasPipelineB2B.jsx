    ...
    <div style={{ background: '#F6F3EC', color: '#1C2B27', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(105deg, rgba(246,243,236,0.97) 0%, rgba(246,243,236,0.93) 38%, rgba(246,243,236,0.72) 58%, rgba(246,243,236,0.15) 72%, transparent 82%)',
        }} />
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '0.6rem', flexWrap: 'wrap', marginBottom: '1.8rem' }}>
            {[
              { label: 'Leads',         color: '#8A6D3B', bg: 'rgba(31,58,51,0.1)' },
              { label: 'Automatisation', color: '#8A6D3B', bg: 'rgba(31,58,51,0.1)' },
              { label: 'Stratégie',      color: '#8A6D3B', bg: 'rgba(31,58,51,0.1)' },
            ].map(t => (
          ...
          <div style={{
            ...
            <span style={{ fontSize: '2.6rem', fontWeight: 700, color: '#8A6D3B', letterSpacing: '-0.03em' }}>+39</span>
            <div>
              <div style={{ fontSize: '0.95rem', fontWeight: 600, color: '#1C2B27' }}>opportunités générées</div>
              <div style={{ fontSize: '0.8rem', color: 'rgba(28,43,39,0.6)' }}>en 2 mois : objectif initial doublé</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            {actions.map((a, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  fontSize: '0.75rem', fontWeight: 700, color: '#8A6D3B',
        ...
        <div className="container">
          <div style={{
            ...
            <p style={{ fontSize: '1.2rem', lineHeight: 1.75, color: 'rgba(28,43,39,0.75)', maxWidth: '820px' }}>
              En deux mois, la direction avait un pipeline structuré, une base de données qualifiée et les premières preuves que le marché répondait favorablement à l'offre. Les <strong style={{ color: '#1C2B27' }}>10 engagements de commandes obtenus en six semaines</strong> ont largement dépassé l'objectif initial de 5 commandes pilotes sur 3 mois.
            </p>
          </div>
        </div>
      </section>
