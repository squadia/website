  ...
  return (
    <div className="fade-in container section-padding" style={{ paddingTop: '160px', paddingBottom: '80px' }}>
      ...
      {(() => {
        ...
        const cardsMap = {
          'strategie-ia-pme-eti': createCard('/blog/strategie-ia-pme-sequence', { border: '#8B5CF6', bg: 'rgba(139, 92, 246, 0.1)', text: '#A78BFA' }, 'Transformation', 'Comment mettre en place une strategie IA en PME et ETI : séquence, outils et premiers résultats'),
          'formation-ia-ou-automatisation': createCard('/blog/formation-ia-automatisation-ordre', { border: '#44CCFF', bg: 'rgba(68, 204, 255, 0.1)', text: '#44CCFF' }, 'Transformation', 'Formation IA ou automatisation des process : dans quel ordre transformer son entreprise ?'),
