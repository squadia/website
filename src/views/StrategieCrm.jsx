...
const fondCrm = '/assets/images/use-crm.jpeg';
const crmVideo = '/assets/video/migration_crm.mp4';
...
// Import Tech Logos
const logoHubspot = '/assets/images/migration/logo/logo-hubspot.png';
const logoPipedrive = '/assets/images/migration/logo/logo-pipedrive.webp';
const logoApollo = '/assets/images/migration/logo/logo-apollo.png';
const logoLemlist = '/assets/images/migration/logo/logo-lemlist.png';
const logoGong = '/assets/images/migration/logo/logo-gong.png';
const logoAirtable = '/assets/images/migration/logo/logo-airtable.png';
const logoRingover = '/assets/images/migration/logo/logo-ringover.png';
const logoTally = '/assets/images/migration/logo/logo-tally.png';
const logoVideoask = '/assets/images/migration/logo/logo-videoask.png';
const logoClaude = '/assets/images/migration/logo/logo-claudeai.webp';
const logoFramer = '/assets/images/migration/logo/logo-framer.png';
// Import Migration Images
const migrationProcess = '/assets/images/migration/migration-process.jpeg';
const migrationData = '/assets/images/migration/migration-data.jpeg';
const migrationMeeting = '/assets/images/migration/migration-meeting.jpeg';
const migrationTraining = '/assets/images/migration/migration-training.jpeg';
const caseImagesDG = {
      ...
      <div style={{ backgroundColor: '#0A0A1A', color: '#F9FAFB', minHeight: '100vh', paddingBottom: '4rem', fontFamily: '"Open Sans", Arial, sans-serif' }}>
        ...
        <section style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 4, height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingLeft: '8%' }}>
            <p style={{ color: '#44CCFF', fontWeight: 700, textTransform: 'uppercase', marginBottom: '1.2rem', letterSpacing: '0.12em', fontSize: '0.9rem' }}>Stratégie</p>
            <motion.h1 
